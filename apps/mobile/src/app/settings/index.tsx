  ...
  const handleDeviceNotificationsChange = useCallback(
    (enabled: boolean) => {
      ...
      Alert.alert(
        ...
        "Notification permission is controlled by iOS. Open Settings to disable notifications for Viper Code.",
        [
          { text: "Cancel", style: "cancel" },
          { text: "Open Settings", onPress: () => void Linking.openSettings() },
        ],
        ...
        <View className="gap-3">
          <SettingsSection title="Account">
            <SettingsRow
              ...
              label="Viper Code Account"
              value={accountLabel}
              onPress={openAccount}
            />
          </SettingsSection>
          <Text className="px-2 text-sm leading-[18px] text-foreground-muted">
            Viper Code works locally without signing in. Cloud features are optional.
          </Text>
        </View>
