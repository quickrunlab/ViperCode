...
} from "@vipercode/client-runtime/platform";
import { ConnectionTransientError } from "@vipercode/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "vipercode.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "vipercode.connections";
