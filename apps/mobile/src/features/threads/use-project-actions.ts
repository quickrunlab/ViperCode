...
import { scopeThreadRef } from "@vipercode/client-runtime/environment";
import { EnvironmentProject } from "@vipercode/client-runtime/state/shell";
import { mapAtomCommandResult } from "@vipercode/client-runtime/state/runtime";
import {
  CommandId,
  MessageId,
  ThreadId,
