...
const CONNECTIONS_KEY = "vipercode.connections";
const PREFERENCES_KEY = "vipercode.preferences";
const AGENT_AWARENESS_DEVICE_ID_KEY = "vipercode.agent-awareness.device-id";
