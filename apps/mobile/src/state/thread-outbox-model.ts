import { isTransportConnectionErrorMessage } from "@vipercode/client-runtime/errors";
import type { EnvironmentShellStatus } from "@vipercode/client-runtime/state/shell";
import { CommandId, EnvironmentId, IsoDateTime, MessageId, ThreadId } from "@vipercode/contracts";
