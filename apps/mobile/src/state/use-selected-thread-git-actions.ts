...
import { EnvironmentProject, EnvironmentThreadShell } from "@vipercode/client-runtime/state/shell";
import type { AtomCommandResult } from "@vipercode/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@vipercode/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@vipercode/contracts";
import {
