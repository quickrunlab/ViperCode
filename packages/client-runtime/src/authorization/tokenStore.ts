...
import { RelayManagedEndpoint } from "@vipercode/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@vipercode/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@vipercode/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
